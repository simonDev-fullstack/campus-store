...
export function EditProductModal({ product, categories, onUpdate, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-xl max-w-4xl w-full my-8 shadow-2xl">
        <div className="sticky top-0 bg-linear-to-r from-indigo-600 to-indigo-700 px-6 py-4 flex items-center justify-between rounded-t-xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              {tags.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center gap-2 px-3 py-1.5 bg-linear-to-r from-indigo-50 to-indigo-100 text-indigo-700 rounded-full border border-indigo-200"
                    >
                      {tag}
                      <button
                        type="button"
          ...
          <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 bg-linear-to-r from-indigo-600 to-indigo-700 text-white rounded-lg hover:from-indigo-700 hover:to-indigo-800 transition-all shadow-lg hover:shadow-xl"
            >
              Update Product
            </button>
          </div>
...
function VariantForm({ onAdd, onCancel }) {
  ...
  return (
    <div className="p-4 border-2 border-indigo-200 rounded-lg bg-indigo-50/50 space-y-4">
      <div>
